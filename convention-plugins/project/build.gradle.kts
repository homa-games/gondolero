...
gradlePlugin {
    plugins {
        register("myAndroid.application.plugin") {
            ...
            implementationClass =
                "com.example.myapplication.conventionplugins.project.MyAndroidApplicationPlugin"
        }
        register("myAndroid.library.plugin") {
            id = "myAndroid.library.plugin"
            implementationClass =
                "com.example.myapplication.conventionplugins.project.MyAndroidLibraryPlugin"
        }
        register("myOptions.compiler.plugin") {
            id = "myOptions.compiler.plugin"
            implementationClass =
                "com.example.myapplication.conventionplugins.project.MyCompileOptionsPlugin"
        }
        register("myKtlint.linter.plugin") {
            id = "myKtlint.linter.plugin"
            implementationClass =
                "com.example.myapplication.conventionplugins.project.MyKtlintPlugin"
        }
    }
}
